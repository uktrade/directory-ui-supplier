...
DOCKER_SET_DEBUG_ENV_VARS := \
	...
	export DIRECTORY_UI_SUPPLIER_FOOD_IS_GREAT_ENABLED_LANGUAGES=en-gb,fr; \
	export DIRECTORY_UI_SUPPLIER_SECURE_HSTS_SECONDS=0; \
	export DIRECTORY_UI_SUPPLIER_LEGAL_IS_GREAT_ENABLED_LANGUAGES=en-gb,fr; \
...
DEBUG_SET_ENV_VARS := \
	...
	export FOOD_IS_GREAT_ENABLED_LANGUAGES=en-gb,fr; \
	export SECURE_HSTS_SECONDS=0 ;\
	export LEGAL_IS_GREAT_ENABLED_LANGUAGES=en-gb,fr; \
	...
	export FEATURE_CMS_ENABLED=false
