...
DOCKER_SET_DEBUG_ENV_VARS := \
	...
	export DIRECTORY_UI_SUPPLIER_UTM_COOKIE_DOMAIN=.trade.great; \
	...
	export DIRECTORY_UI_SUPPLIER_PRIVACY_COOKIE_DOMAIN=.trade.great; \
	export DIRECTORY_UI_SUPPLIER_HEALTH_CHECK_TOKEN=debug
